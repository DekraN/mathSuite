...
#define BITMASK_ITEMSAUTOSAVING 8
	...
	#define BITMASK_ADVCALCPARSING 32
	#define BITMASK_MATRIXPARSING 64
	#define BITMASK_RESETLISTS 128
	#define BITMASK_SAVERESULTS 256
	#define BITMASK_SHOWVARLIST 512
	#define BITMASK_SHOWDIFFTIME 1024
	#define BITMASK_SHOWDIFFTIMEADVCALC 2048
	#define BITMASK_SHOWDIFFTIMEALGOPS 4096
	#define BITMASK_SHOWEXECTIME 8192
	#define BITMASK_PRINTTIME 16384
	#define BITMASK_PRINTROWSLABELS 32768
	#define BITMASK_DOMAINCHECK 65536
	#define BITMASK_CHARINSERT 131072
	#define BITMASK_INSERTMODE 262144
	#define BITMASK_LAZYEXECUTION 524288
	#define BITMASK_INVERSEOPERATIONS 1048576
	#define BITMASK_AUTOTURNBACK 2097152
	#define BITMASK_DEGREESENTERING 4194304
	#define BITMASK_PROGREPEATCHECK 8388608
	#define BITMASK_STRASSENOPTIMIZATION 16777216
#endif
...
__MSUTIL_ ityp __export afact(register ityp n);
...
__MSNATIVE_ ityp __export math_mode(uint64_t dim, ityp [static dim]);
