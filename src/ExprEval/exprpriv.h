...
enum
    ...
    //
    EXPR_NODEFUNC_CELSIUSFAHRENHEIT,
    EXPR_NODEFUNC_CELSIUSKELVIN,
    EXPR_NODEFUNC_CELSIUSRANKINE,
    EXPR_NODEFUNC_CELSIUSREAUMUR,
    EXPR_NODEFUNC_CELSIUSNEWTON,
    EXPR_NODEFUNC_CELSIUSDELISLE,
    EXPR_NODEFUNC_CELSIUSROMER,
    EXPR_NODEFUNC_FAHRENHEITKELVIN,
    EXPR_NODEFUNC_FAHRENHEITRANKINE,
    EXPR_NODEFUNC_FAHRENHEITREAUMUR,
    EXPR_NODEFUNC_REAUMURRANKINE,
    //
    EXPR_NODEFUNC_SPEED,
    //
    EXPR_NODEFUNC_DAY,
