...
int exprFuncListInit(exprFuncList *flist)
    ...
    EXPR_ADDFUNC_TYPE(IDENTIFIER_BLOCKSIZE, EXPR_NODEFUNC_BLOCKSIZE, 0, 1, 0, 0);
    EXPR_ADDFUNC_TYPE(IDENTIFIER_ALIAS_MINOSMMDIM, EXPR_NODEFUNC_MINOSMMDIM, 0, 1, 0, 0);
    EXPR_ADDFUNC_TYPE(IDENTIFIER_ALIAS_MINSTRASSENDIM, EXPR_NODEFUNC_MINSTRASSENDIM, 0, 1, 0, 0);
