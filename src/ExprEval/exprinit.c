...
int exprFuncListInit(exprFuncList *flist)
    ...
    EXPR_ADDFUNC_TYPE(IDENTIFIER_COMPLEXSUM, EXPR_NODEFUNC_COMPLEXSUM, MAX_COMPLEX_UNITS<<1, MAX_COMPLEX_UNITS<<1, MAX_COMPLEX_UNITS, MAX_COMPLEX_UNITS);
    EXPR_ADDFUNC_TYPE(IDENTIFIER_COMPLEXPROD, EXPR_NODEFUNC_COMPLEXPROD, MAX_COMPLEX_UNITS<<1, MAX_COMPLEX_UNITS<<1, MAX_COMPLEX_UNITS, MAX_COMPLEX_UNITS);
    EXPR_ADDFUNC_TYPE(IDENTIFIER_QUATERNIONSSUM, EXPR_NODEFUNC_QUATERNIONSSUM, MAX_QUATERNIONS_UNITS<<1, MAX_QUATERNIONS_UNITS<<1, MAX_QUATERNIONS_UNITS, MAX_QUATERNIONS_UNITS);
    EXPR_ADDFUNC_TYPE(IDENTIFIER_QUATERNIONSPROD, EXPR_NODEFUNC_QUATERNIONSPROD, MAX_QUATERNIONS_UNITS<<1, MAX_QUATERNIONS_UNITS<<1, MAX_QUATERNIONS_UNITS, MAX_QUATERNIONS_UNITS);
