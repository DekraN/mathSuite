#ifndef __DISABLEDEEP_CORDIC

#include "../dutils.h"

/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _angle_shift ( void * data)
/******************************************************************************/
/*
  Purpose:
    ANGLE_SHIFT shifts angle ALPHA to lie between BETA and BETA+2PI.
  Discussion:
    The input angle ALPHA is shifted by multiples of 2 * M_PI to lie
    between BETA and BETA+2*M_PI.
...
*/
{
	...
	result = beta + alpha<beta ? - fmod ( beta - alpha, M_2TPI ) + M_2TPI : fmod ( alpha - beta, 2.00 * M_PI );
    return &result;
}

#define CORDIC_INVALIDRETURNVALUE MAX_VAL

/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _acos_cordic ( void * data)
/******************************************************************************/
/*
  Purpose:
    acos_CORDIC returns the acosine of an angle using the CORDIC method.
  Licensing:
    This code is distributed under the GNU LGPL license.
  Modified:
    19 January 2012
  ...
  Parameters:
    ...
    iterations.
    Output, double acos_CORDIC, an angle whose cosine is T.
  Local Parameters:
...
*/
{
	...
	ityp * const a_data = data;
	register ityp t = a_data[0];
	register ityp n = a_data[1];
	
    # define ANGLES_LENGTH 60

    ityp angle;
    ityp angles[ANGLES_LENGTH] =
    {
    ...
    if ( 1.0 < fabs ( t ) )
    {
    	result = CORDIC_INVALIDRETURNVALUE;
        return &result;
    }
    ...
    {
        sign_z2 = 1-((y1<0.00)<<1);
        sigma = sign_z2 * (1-((t>x1)<<1));
        angle = j<=ANGLES_LENGTH ? angles[j-1] : angle/2.00;
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _asin_cordic ( void * data)
/******************************************************************************/
/*
  Purpose:
    asin_cordic returns the arcsine of an angle using the CORDIC method.
  Licensing:
    This code is distributed under the GNU LGPL license.
  Modified:
    19 January 2012
  ...
  Parameters:
    ...
    A value of 10 is low.  Good accuracy is achieved with 20 or more
    iterations.
    Output, double asin_cordic, an angle whose sine is T.
  Local Parameters:
    Local, double ANGLES(60) = arctan ( (1/2)^(0:59) );
*/
{
    ...
    for ( j = 1; j <= n; ++j )
    {
        sign_z1 = 1.00 - ((x1<0.00)<<1);
        sigma = sign_z1 * (1-((t>y1)<<1));
        angle = j<= ANGLES_LENGTH ? angles[j-1] : angle/2.00;
        #pragma omp parallel for num_threads(2)
        for ( i = 1; i <= 2; ++i )
        {
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _atan_cordic ( void * data)
/******************************************************************************/
/*
  Purpose:
    atan_cordic returns the arctangent of an angle using the CORDIC method.
  Licensing:
    This code is distributed under the GNU LGPL license.
  Modified:
    15 June 2007
  ...
  Parameters:
    ...
    A value of 10 is low.  Good accuracy is achieved with 20 or more
    iterations.
    Output, double atan_cordic, the angle whose tangent is Y/X.
  Local Parameters:
    Local, double ANGLES(60) = arctan ( (1/2)^(0:59) );
*/
{
    ...
    */
    ...
    result = theta*sign_factor;
    return &result;
    # undef ANGLES_LENGTH
}

/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _cbrt_cordic ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _exp_cordic ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
    ...
    */
    ...
    for ( i = 0; i < n; ++i )
    {
        ai = i<A_LENGTH ? a[i] : 1.00 + ( ai - 1.00 ) / 2.00;
    ...
    */
    fx *=               ( 1.00 + z           * ( 1.00 + z / 2.00 * ( 1.00 + z / 3.00 * ( 1.00 + z / 4.00 ))));
    /*
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _ln_cordic ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
    ...
    */
    ...
    x -= 1.00;
    x *= ( 1.00 - ( x / 2.00 )* ( 1.00 + ( x / 3.00 )*( 1.00 -   x / 4.00 )));
    /*
    Assemble
    */
    poweroftwo = 0.50;
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _sqrt_cordic ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _tan_cordic ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
    ...
    ityp theta;
    /*
    Shift angle to interval [-M_PI,M_PI].
    */
    theta = angle_shift ( beta, -M_PI );
    /*
    Shift angle to interval [-M_PI/2,M_PI/2].
    */
    if ( theta < - 0.5 * M_PI )
        theta += M_PI;
    else if ( 0.5 * M_PI < theta )
        theta -= M_PI;
    ...
    for ( j = 1; j <= n; ++j )
    {
        ...
        */
        angle = ANGLES_LENGTH < j+1 ? angle/2.00 : angles[j];
    }
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *  _acos_values ( void * data)
/******************************************************************************/
/*
  Purpose:
    acos_VALUES returns some values of the arc cosine function.
  Discussion:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *  _arcsin_values ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *  _arctan_values ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *  _cbrt_values ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *  _cos_values ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void * _exp_values ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _ln_values ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *  _sin_values ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void * _sqrt_values ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void * _tan_values ( void * data)
/******************************************************************************/
/*
  Purpose:
