#ifndef __DISABLEDEEP_RBFINTERPND

#include "../dutils.h"

/******************************************************************************/
__MATHSUITE __JBURKARDT  ityp   *rbf_interp_nd ( const register dim_typ m, const register dim_typ nd, ityp xd[static m*nd], const register ityp r0,void phix ( int n, ityp r[], ityp r0, ityp v[] ), ityp w[static nd],const register dim_typ ni, ityp xi[static m*ni] )
/******************************************************************************/
/*
  Purpose:
