#ifndef __DISABLEDEEP_TRIANGLENCCRULE

#include "../dutils.h"

/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _triangle_ncc_degree ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _triangle_ncc_order_num ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _triangle_ncc_rule ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _triangle_ncc_rule_num ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void   * _triangle_ncc_suborder ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
    ...
    switch(rule)
    {
        ...
        case 6:
            ...
            break;
        case 7:
            suborder[0] = suborder[1] = suborder[4] = 6;
            suborder[2] = suborder[3] = 3;
            suborder[5] = 1;
            break;
        case 8:
            ...
            break;
        case 9:
            suborder[0] = suborder[1] = suborder[3] = suborder[4] = suborder[6] = 6;
            suborder[2] = suborder[5] = suborder[7] = suborder[8] = 3;
            break;
    }
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _triangle_ncc_suborder_num ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *  _triangle_ncc_subrule ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
    ...
    {
        case 1:
            triangle_ncc_subrule_01 ( suborder_num, suborder_xyz_n, &suborder_xyz_d,suborder_w_n, &suborder_w_d );
            break;
        case 2:
            triangle_ncc_subrule_02 ( suborder_num, suborder_xyz_n, &suborder_xyz_d,suborder_w_n, &suborder_w_d );
            break;
        case 3:
            triangle_ncc_subrule_03 ( suborder_num, suborder_xyz_n, &suborder_xyz_d,suborder_w_n, &suborder_w_d );
            break;
        case 4:
            triangle_ncc_subrule_04 ( suborder_num, suborder_xyz_n, &suborder_xyz_d,suborder_w_n, &suborder_w_d );
            break;
        case 5:
            triangle_ncc_subrule_05 ( suborder_num, suborder_xyz_n, &suborder_xyz_d,suborder_w_n, &suborder_w_d );
            break;
        case 6:
            triangle_ncc_subrule_06 ( suborder_num, suborder_xyz_n, &suborder_xyz_d,suborder_w_n, &suborder_w_d );
            break;
        case 7:
            triangle_ncc_subrule_07 ( suborder_num, suborder_xyz_n, &suborder_xyz_d,suborder_w_n, &suborder_w_d );
            break;
        case 8:
            triangle_ncc_subrule_08 ( suborder_num, suborder_xyz_n, &suborder_xyz_d,suborder_w_n, &suborder_w_d );
            break;
        case 9:
            triangle_ncc_subrule_09 ( suborder_num, suborder_xyz_n, &suborder_xyz_d,suborder_w_n, &suborder_w_d );
            break;
        default:
            return NULL;
    }
    ...
    for ( s = 0; s < suborder_num; ++s)
    {
        #pragma omp parallel for num_threads(3)
        for ( i = 0; i < 3; ++i )
            suborder_xyz[i+s*3] =( ityp ) ( suborder_xyz_n[i+s*3] )/ ( ityp ) ( suborder_xyz_d );
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _triangle_ncc_subrule_01 ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
    ...
    const register dim_typ suborder_xyz_d_01 = 3;
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _triangle_ncc_subrule_02 ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _triangle_ncc_subrule_03 ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
    ...
    const register dim_typ suborder_w_d_03 = 3;
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _triangle_ncc_subrule_04 ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
    ...
    const register dim_typ suborder_w_d_04 = 120;
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _triangle_ncc_subrule_05 ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
    ...
    int suborder_w_n_05[3] =
    {
        4, -1, 8
    };
    const register dim_typ suborder_w_d_05 = 45;
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _triangle_ncc_subrule_06 ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
    ...
    const register dim_typ suborder_w_d_06 = 1008;
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *    _triangle_ncc_subrule_07 ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
    ...
    int suborder_w_n_07[6] =
    {
        36, -27, 72, 64, 72, -54
    };
    const register dim_typ suborder_w_d_07 = 840;
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _triangle_ncc_subrule_08 ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
    ...
    const register unsigned suborder_w_d_08 = 259200;
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _triangle_ncc_subrule_09 ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
    ...
    const register dim_typ suborder_w_d_09 = 14175;
