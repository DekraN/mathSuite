#ifndef __DISABLEDEEP_DIVDIF

#include "../dutils.h"

/******************************************************************************/
__MATHSUITE __JBURKARDT  void   * _cheby_t_zero ( void * data)
/******************************************************************************/
/*
  Purpose:
    CHEBY_T_ZERO returns zeroes of the Chebyshev polynomial T(N)(X).
  Discussion:
    The I-th zero of T(N)(X) is cos((2*I-1)*M_PI/(2*N)), I = 1 to N
  Licensing:
...
*/
{
    ...
    {
        angle = ( ityp ) ( (i<<1) + 1 ) * M_PI / ( ityp ) ( (n<<1) );
        z[i] = cos ( angle );
    }
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void   * _cheby_u_zero ( void * data)
/******************************************************************************/
/*
  Purpose:
    CHEBY_U_ZERO returns zeroes of the Chebyshev polynomial U(N)(X).
  Discussion:
    The I-th zero of U(N)(X) is cos((I-1)*M_PI/(N-1)), I = 1 to N
  Licensing:
    This code is distributed under the GNU LGPL license.
  Modified:
    24 May 2011
...
*/
{
    ...
    for (dim_typ i = 0; i < n; ++i )
    {
        angle = ( ityp ) ( i + 1 ) * 141592653589793 / ( ityp ) ( n + 1 );
        z[i] = cos ( angle );
    }
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _data_to_dif ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
	...
	const register dim_typ ntab = s_data->a0;
	ityp * xtab = s_data->a1;
	ityp * ytab = s_data->a2;
	ityp * diftab = s_data->a3;
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _data_to_r8poly ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *  _dif_antideriv ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
	...
	const register dim_typ ntab = s_data->a0;
	ityp * xtab = s_data->a1;
	ityp * diftab = s_data->a2;
	dim_typ * ntab2 = s_data->a3;
	ityp * xtab2 = s_data->a4;
	ityp * diftab2 = s_data->a5;
	
    dim_typ i;
    ityp *xtab1 = ( ityp * ) malloc ( ntab * sizeof ( ityp ) );
    ityp *diftab1 = ( ityp * ) malloc ( ntab * sizeof ( ityp ) );
    /*
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *  _dif_append ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
	const dt2pit2itpdt2pit * const s_data = data;
	const register dim_typ ntab = s_data->a0;
	ityp * xtab = s_data->a1;
	ityp * diftab = s_data->a2;
	ityp xval = s_data->a3;
	ityp yval = s_data->a4;
	dim_typ * ntab2 = s_data->a5;
	ityp * xtab2 = s_data->a6;
	ityp * diftab2 = s_data->a7;
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _dif_basis ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _dif_basis_deriv ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
    ...
    ityp *dd = ( ityp * ) malloc ( nd * sizeof ( ityp ) );
    dim_typ i, j;
    ityp *yd = ( ityp * ) malloc ( nd * sizeof ( ityp ) );
    /*
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *  _dif_basis_derivk ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _dif_basis_i ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
	...
	const register dim_typ ival = s_data->a0;
	const register dim_typ ntab = s_data->a1;
	ityp * xtab = s_data->a2;
	ityp * diftab = s_data->a3;
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _dif_deriv_table ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _dif_derivk_table ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
	const dt2piti2pit * const s_data = data;
	const register dim_typ nd = s_data->a0;
	ityp * xd = s_data->a1;
	ityp * dd = s_data->a2;
	int k = s_data->a3;
    ...
    */
    ...
    xd_temp = ( ityp * ) malloc ( ndk * sizeof ( ityp ) );

    for ( i = 0; i < ndk; i++ )
        xd_temp[i] = xd[i];
        
    dd_temp = ( ityp * ) malloc ( ndk * sizeof ( ityp ) );
    for ( i = 0; i < ndk; ++i )
        dd_temp[i] = dd[i];
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _dif_val ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
	...
	const register dim_typ ntab = s_data->a0;
	const register ityp xv = s_data->a1;
	ityp * xtab = s_data->a2;
	ityp * diftab = s_data->a3;
	
    ityp yv = diftab[ntab-1];
    for (dim_typ i = 2; i <= ntab; ++i )
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void   * _lagrange_rule ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _lagrange_sum ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *  _lagrange_val ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *  _nc_rule ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
	...
	const register dim_typ norder = s_data->a0;
    ...
    dim_typ i;
    ityp *poly_cof = ( ityp * ) malloc ( norder * sizeof ( ityp ) );
    ityp yvala;
    ityp yvalb;
    /*
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _ncc_rule ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
    ...
    */
    ...
    for (dim_typ i = 1; i <= norder; ++i )
        xtab[i-1] = ( ( ityp ) ( norder - i     ) * a+ ( ityp ) (          i - 1 ) * b )/ ( ityp ) ( norder     - 1 );
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *  _nco_rule ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
    ...
    for (dim_typ i = 1; i <= norder; ++i )
        xtab[i-1] = ( ( ityp ) ( norder + 1 - i ) * a+ ( ityp ) (              i ) * b )/ ( ityp ) ( norder + 1 );
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *  _r8_swap ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _r8poly_ant_cof ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
    ...
    */
    for (dim_typ i = 1; i <= n; ++i )
        poly_cof2[i] = poly_cof[i-1] / ( ityp ) i;
    return NULL;
}

/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _r8poly_basis ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *  _r8poly_basis_1 ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void * _r8poly_der_cof ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
    ...
    for (dim_typ i = 0; i < n; ++i )
        poly_cof2[i] = ( ityp ) ( i + 1 ) * poly_cof[i+1];
    return NULL;
}

/******************************************************************************/
__MATHSUITE __JBURKARDT  void *  _r8poly_der_val ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
    ...
    ityp value = ( ityp ) ( n - 1 ) * poly_cof[n-1];
    for (dim_typ i = n-2; 1 <= i; --i )
        value *= xval + ( double ) i * poly_cof[i];
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *  _r8poly_order ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _r8poly_shift ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
	...
	const register dim_typ n = s_data->a0;
	const register ityp scale = s_data->a1;
	const register ityp shift = s_data->a2;
	ityp * poly_cof = s_data->a3;
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _r8poly_val_horner ( void * data )
/******************************************************************************/
/*
  Purpose:
...
*/
{
    ...
    ityp value = poly_cof[n-1];
    for (dim_typ i = n-2; 0 <= i; --i )
        value *= xval + poly_cof[i];
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *  _r8vec_indicator ( void * data)
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _roots_to_dif ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
	const dtpitpdt2pit * const s_data = data;
	const register dim_typ nroots = s_data->a0;
	ityp * roots = s_data->a1;
	dim_typ * ntab = s_data->a2;
	ityp * xtab = s_data->a3;
	ityp * diftab = s_data->a4;
...
/******************************************************************************/
__MATHSUITE __JBURKARDT  void *   _roots_to_r8poly ( void * data)
/******************************************************************************/
/*
  Purpose:
...
*/
{
	...
	ityp * roots = s_data->a0;
	const register dim_typ nroots = s_data->a1;
	int * nc = s_data->a2;
	ityp * c = s_data->a3;
	
	
    dim_typ i;
    ityp *xtab = ( ityp * ) malloc ( ( nroots + 1 ) * sizeof ( ityp ) );
